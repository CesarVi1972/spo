...
.NOTES
Script extracted from https://docs.microsoft.com/en-us/sharepoint/dev/transform/modernize-connect-to-office365-group#connect-an-office-365-group-using-the-sharepoint-user-interface

.EXAMPLE
.\O365GroupConnectSite.ps1
#>
...
# Tenant admin url
$tenantAdminUrl = "https://microsoft365demo-admin.sharepoint.com" # e.g. "https://contoso-admin.sharepoint.com"
